...
// ========== clothing ===========
// ========== uniforms ===========
_plebUniform = "";	// leave as "" for default
...
// =========== helmets ===========
_plebHelmet = "H_Booniehat_khk_hs";
...
_scoped_rifleAttachments = ["optic_MRCO","acc_pointer_IR"];
_scoped_autoRifleAttachments = ["optic_MRCO","acc_pointer_IR"];
_scoped_mmgAttachments = ["optic_MRCO","acc_pointer_IR"];
