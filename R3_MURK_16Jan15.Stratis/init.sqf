...
r_param_mission_timer = (["SafeStart",0] call BIS_fnc_GetParamValue);

//=====================================================================================
// DAC Headless Client Parameter

if ((["HeadlessClient",0] call BIS_fnc_GetParamValue) == 1) then { r_var_headlessClient = true; } else { r_var_headlessClient = false; };
