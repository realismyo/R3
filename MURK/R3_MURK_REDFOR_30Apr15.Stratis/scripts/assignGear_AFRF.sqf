...
- nul = [this,"loadout"] execVM "scripts\assignGear_AFRF.sqf";
e.g. - nul = [this,"pltld"] execVM "scripts\assignGear_AFRF.sqf";
...
- nul = [this,"loadout",nightGear,scopes,suppressors,"camopattern"] execVM "scripts\assignGear_AFRF.sqf";
e.g. - nul = [this,"pltld",true,false,true,"woodland"] execVM "scripts\assignGear_AFRF.sqf";
...
_camoPattern = "summer";		// Camo pattern for RU forces. Default: "summer". Available cases: "summer", "flora", "mountainflora". Requires lower case string value.
...
#include "assignGearDefines_AFRF.sqf";					
