...
- nul = [this,"loadout"] execVM "scripts\assignGear_CSAT_G3.sqf";
e.g. - nul = [this,"pltld"] execVM "scripts\assignGear_CSAT_G3.sqf";
...
- nul = [this,"loadout",nightGear,scopes,suppressors,"camopattern"] execVM "scripts\assignGear_CSAT_G3.sqf";
e.g. - nul = [this,"pltld",true,false,true,"navy"] execVM "scripts\assignGear_CSAT_G3.sqf";
...
- Check the assignGearDefines_CSAT_G3.sqf for defined variables, alter them in that script. 
...
#include "assignGearDefines_CSAT_G3.sqf";					
...
switch (_loadout) do {									
	...
	case "rmsc" : {
		["pleb"] call _addClothes;
		call _addBasics;
		_unit addMagazines [_rifleScopedMag,11];
	...
	case "gren" : {
		...
		call _addBasics;
		_unit addMagazines [_rifleGLMag,11];
		_unit addMagazines [_glExplody,5];
		_unit addMagazines [_glSmokeOne,1];
		_unit addMagazines [_glSmokeTwo,1];
		_unit addWeapon _rifleGL;
