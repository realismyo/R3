...
r_fnc_assignGear = compile preprocessfilelinenumbers "scripts\assignGear_AAF.sqf";
...
// ====================================================================================
// DAC Initialisation.
// Runs DAC according to r_var_headlessClient parameter.

// function to init DAC and spawn the zones
r_fnc_initDAC = {

	// wait until bis functions are initialized
	...
	// spawn the disabled spawn zones
	[] execVM "scripts\dac\spawnDACZones.sqf";
	
	// create the disabled spawn zones
	//[] execVM "scripts\dac\createDACZones.sqf";
};

// if HC present, spawn units on HC
if (r_var_headlessClient) then {
