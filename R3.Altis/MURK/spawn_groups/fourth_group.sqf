...
// Example: nul = [this,"once"] execVM "murk\spawn_groups\fourth_group.sqf"; ---- Will spawn the editor unit based on the trigger in fourth_group script
// Example: nul = [this,"repeated",4,30] execVM "murk\spawn_groups\fourth_group.sqf"; ---- Will spawn the editor unit based on the trigger in fourth_group script, then respawn it 4 times with a 30 second delay upon death
// Example: nul = [this,"wave",5,60] execVM "murk\spawn_groups\fourth_group.sqf"; ---- Will spawn the editor unit once based on the trigger in fourth_group script, then respawn the entire group (regardless of deaths) 5 times 60 seconds between
