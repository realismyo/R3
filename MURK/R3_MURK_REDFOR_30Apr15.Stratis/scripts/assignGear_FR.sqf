...
- Current Side, Faction: BLUFOR, FR
- Required Mods: @AGM, @task_force_radio, @r3f_armes, @r3f_uniformes, @RHS_USF
...
- nul = [this,"loadout"] execVM "scripts\assignGear_FR.sqf";
e.g. - nul = [this,"pltld"] execVM "scripts\assignGear_FR.sqf";
- This would equip a FR platoon leader with the gear defined below.
...
- nul = [this,"loadout",nightGear,scopes,suppressors,"camopattern"] execVM "scripts\assignGear_FR.sqf";
e.g. - nul = [this,"pltld",false,true,false,"desert"] execVM "scripts\assignGear_FR.sqf";
- This example would equip a FR desert platoon leader with no night gear, a scope, no suppresssor and Desert Camo equipment.
...
- Check the assignGearDefines_ACR.sqf for defined variables, alter them in that script. 
...
_camoPattern = "woodland";			// Camo pattern for FR forces. Default: "woodland". Available cases: "woodland", "desert". Requires lower case string value.
_radioSelection = "defined";		// Radio assignment. "detection" for side detect & assignment, "defined" for script defined radio & assignment. 
...
#include "assignGearDefines_FR.sqf";
...
switch (_loadout) do {
	...
	case "ar" : {
		["pleb"] call _addClothes;
		call _addBasics;
		_unit addMagazines [_autoRifleMag,2];
