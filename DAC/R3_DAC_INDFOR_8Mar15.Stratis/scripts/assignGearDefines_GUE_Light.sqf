...
// ===============================
// ======= General Weapons =======
_rifleArray = ["hlc_rifle_aks74","hlc_rifle_ak74","hlc_rifle_ak12","rhs_weap_m4","rhs_weap_m4a1","rhs_weap_m16a4_carryhandle","arifle_TRG21_F"];
_rifleRandom = (floor(random (count _rifleArray)));
_rifle = _rifleArray select _rifleRandom;

_rifleGLArray = ["hlc_rifle_aks74_GL","rhs_m4_m320","rhs_m4a1_m320","arifle_TRG21_GL_F"];
_rifleGLRandom = (floor(random (count _rifleGLArray)));
_rifleGL = _rifleGLArray select _rifleGLRandom;

_rifleScopedArray = ["hlc_rifle_aks74","hlc_rifle_ak74","hlc_rifle_ak12","rhs_weap_m4a1","rhs_weap_m16a4_carryhandle","arifle_TRG21_F"];
...
_flashbang = "AGM_M84";
// ====== General Magazines ======
_rifleMagArray = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","30Rnd_556x45_Stanag"];
_rifleMag = _rifleMagArray select _rifleRandom;

_rifleTracerMagArray = ["hlc_30Rnd_545x39_T_AK","hlc_30Rnd_545x39_T_AK","hlc_30Rnd_545x39_T_AK","rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red","rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red","rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red","30Rnd_556x45_Stanag_Tracer_Red"];
_rifleTracerMag = _rifleTracerMagArray select _rifleRandom;

_rifleGLMagArray = ["hlc_30Rnd_545x39_B_AK","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","30Rnd_556x45_Stanag"];
_rifleGLMag = _rifleGLMagArray select _rifleGLRandom;

_rifleScopedMagArray = ["hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","hlc_30Rnd_545x39_B_AK","rhs_mag_30Rnd_556x45_Mk262_Stanag","rhs_mag_30Rnd_556x45_Mk262_Stanag","30Rnd_556x45_Stanag"];
...
// ======== Attachments ==========
_rifleAttachmentArray = [["hlc_optic_kobra","acc_flashlight"],["hlc_optic_kobra","acc_flashlight"],["optic_ACO_grn","acc_flashlight"],["rhsusf_acc_compm4","acc_flashlight"],["rhsusf_acc_compm4","acc_flashlight"],["rhsusf_acc_compm4","acc_flashlight"],["optic_ACO_grn","acc_flashlight"]];
_rifleAttachments = _rifleAttachmentArray select _rifleRandom;

_rifleGLAttachmentArray = [["hlc_optic_kobra","acc_flashlight"],["rhsusf_acc_compm4","acc_flashlight"],["rhsusf_acc_compm4","acc_flashlight"],["optic_ACO_grn","acc_flashlight"]];
_rifleGLAttachments = _rifleGLAttachmentArray select _rifleGLRandom;

_rifleScopedAttachmentArray = [["HLC_Optic_PSO1","acc_flashlight"],["HLC_Optic_PSO1","acc_flashlight"],["optic_MRCO","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["optic_MRCO","acc_flashlight"]];
...
_scoped_rifleAttachmentArray = [["HLC_Optic_PSO1","acc_flashlight"],["HLC_Optic_PSO1","acc_flashlight"],["optic_MRCO","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["optic_MRCO","acc_flashlight"]];
_scoped_rifleAttachments = _scoped_rifleAttachmentArray select _rifleRandom;

_scoped_rifleGLAttachmentArray = [["HLC_Optic_PSO1","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["optic_MRCO","acc_flashlight"]];
_scoped_rifleGLAttachments = _scoped_rifleGLAttachmentArray select _rifleGLRandom;

_scoped_rifleScopedAttachmentArray = [["HLC_Optic_PSO1","acc_flashlight"],["HLC_Optic_PSO1","acc_flashlight"],["optic_MRCO","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["rhsusf_acc_ACOG3","acc_flashlight"],["optic_MRCO","acc_flashlight"]];
...
_suppressed_rifleAttachmentArray = [["hlc_muzzle_545SUP_AK"],["hlc_muzzle_545SUP_AK"],["hlc_muzzle_545SUP_AK"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"]];
_suppressed_rifleAttachments = _suppressed_rifleAttachmentArray select _rifleRandom;

_suppressed_rifleGLAttachmentArray = [["hlc_muzzle_545SUP_AK"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"]];
_suppressed_rifleGLAttachments = _suppressed_rifleGLAttachmentArray select _rifleGLRandom;

_suppressed_rifleScopedAttachmentArray = [["hlc_muzzle_545SUP_AK"],["hlc_muzzle_545SUP_AK"],["hlc_muzzle_545SUP_AK"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"]];
_suppressed_rifleScopedAttachments = _suppressed_rifleScopedAttachmentArray select _rifleScopedRandom;

_suppressed_carbineAttachmentArray = [["hlc_muzzle_545SUP_AK"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"],["muzzle_snds_M"]];
