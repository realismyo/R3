...
- Current Side, Faction: OPFOR, CSAT (URBAN)
...
- nul = [this,"desiredloadouthere"] execVM "scripts\assignGear_CSATUrban.sqf";
e.g. - nul = [this,"pltld"] execVM "scripts\assignGear_CSATUrban.sqf";
...
"_underwaterWeapons","_nightGear","_scopes","_suppressors"
];
...
#include "assignGearDefines_CSATUrban.sqf";					// faction specific script with all of the variables
