...
// For example:
// example = createTrigger["EmptyDetector", (getMarkerPos "zonePos_exampleZone")];
// example setTriggerArea[100, 100, 0, true];
// example setTriggerActivation["NONE", "PRESENT", true];
// example setTriggerStatements["true", "exampleZoneDAC = [""exampleZone"",[1,1,0],[5,3,5,20],[2,2,5,20],[],[],[0,1,0,0,0]]spawn DAC_Zone", ""];
// example setTriggerTimeout[0, 0, 0, false];
