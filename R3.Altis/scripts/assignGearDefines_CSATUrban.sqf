...
// ========== clothing ===========
// ========== uniforms ===========
_plebUniform = "U_O_CombatUniform_oucamo";	// leave as "" for default
...
// ============ rucks ============
_plebRuck = "B_FieldPack_oucamo";
_medRuck = "B_FieldPack_oucamo_Medic";
_assistantRuck = "B_Carryall_oucamo";
_uavRuck = "O_UAV_01_backpack_F";
_diverRuck = "B_AssaultPack_blk";
_sniperRuck = "B_FieldPack_oucamo";
