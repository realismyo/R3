...
class cratePicker {
    ...
    onLoad = "if (isNil 'r_var_cratepicker_init') then {call compile preprocessFileLineNumbers 'scripts\cratePicker\cratePicker.sqf'}; _this call r_initCratePicker;";
    ...
    class controls {
        class CrateList : CommonSettings {
            idc = 1;
            type = CT_COMBO;
            x = SafeZoneX + 0.23;
            y = SafeZoneY + 0.26;
            ...
            onLBSelChanged = "call r_cratePicker_OnSelChanged";
        };
        ...
        class AcceptButton : CommonSettings {
            ...
            x = SafeZoneX + 0.23;
            y = SafeZoneY + 0.31;
            text = "Spawn this Crate";
            action = "call r_spawnSelectedCrate";
        };
    };
};
