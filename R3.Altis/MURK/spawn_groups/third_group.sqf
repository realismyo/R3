...
// Example: nul = [this,"once"] execVM "murk\spawn_groups\third_group.sqf"; ---- Will spawn the editor unit based on the trigger in third_group script
// Example: nul = [this,"repeated",4,30] execVM "murk\spawn_groups\third_group.sqf"; ---- Will spawn the editor unit based on the trigger in third_group script, then respawn it 4 times with a 30 second delay upon death
// Example: nul = [this,"wave",5,60] execVM "murk\spawn_groups\third_group.sqf"; ---- Will spawn the editor unit once based on the trigger in third_group script, then respawn the entire group (regardless of deaths) 5 times 60 seconds between
// Example: nul = [this,"reset",5] execVM "murk\spawn_groups\third_group.sqf"; ---- Will spawn the editor unit once based on the trigger in third_group script, then reset the trigger after a preset time (20 seconds default). The unit will be created when trigger is true again, maximum number of lives.
// -----------------------------------------------------------------------------------------------------
...
// CHANGE THIS TRIGGER
#define SPAWN_TRIGGER_VARIABLE third_group
// CHANGE THIS TRIGGER
