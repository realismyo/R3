...
"_plebHelmet",
"_smallRuck","_glVest","_medVest",
"_plebVest","_medRuck","_largeRuck","_uavRuck",
...
switch (_camoPattern) do {
	case "arid" : {
		...
		// ============ Rucks ============
		_smallRuck = "TEC_B_Fieldpack_Arid";
		_medRuck = "TEC_B_Kitbag_Arid";
		_largeRuck = "TEC_B_Carryall_Arid";
	...
	case "navy" : {
		...
		_medVest = "TEC_V_PC_Light_Black";
		// ============ Rucks ============
		_smallRuck = "B_FieldPack_blk";
		_medRuck = "TEC_B_Kitbag_Urban";
		_largeRuck = "TEC_B_Carryall_Urban";
	...
	case "semiarid" : {
		...
		_medVest = "TEC_V_PC_Light_Black";
		// ============ Rucks ============
		_smallRuck = "TEC_B_Fieldpack_Semiarid";
		_medRuck = "TEC_B_Kitbag_Semiarid";
		_largeRuck = "TEC_B_Carryall_Semiarid";
	...
	case "urban" : {
		...
		_medVest = "TEC_V_PC_Light_Black";
		// ============ Rucks ============
		_smallRuck = "TEC_B_Fieldpack_Urban";
		_medRuck = "TEC_B_Kitbag_Urban";
		_largeRuck = "TEC_B_Carryall_Urban";
	...
	case "woodland" : {
		...
		_medVest = "TEC_V_PC_Light_Black";
		// ============ Rucks ============
		_smallRuck = "TEC_B_Fieldpack_Woodland";
		_medRuck = "TEC_B_Kitbag_Woodland";
		_largeRuck = "TEC_B_Carryall_Woodland";
